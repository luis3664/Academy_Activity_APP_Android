...
import com.curso.android.app.practica.projectofinal.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.botonComparar.setOnClickListener {
            mainViewModel.comparTexts(binding.text1.text.toString(), binding.text2.text.toString())
        }
    }
}